...
export const projects: Project[] = [
  {
    ...
    summary: `Urban transportation systems (UTS) play a pivotal role in our society, but its sustainability is increasingly imperiled by the escalating climate crisis. It is paramount to enhance climate resilience of UTS, which heavily relies on data-driven and evidence-based decision-making.

    Transportation data is sourced from a multitude of sensors, devices, and data providers, each utilizing distinct data models and standards. However, with the increasing volume and variety of data about different aspects of the complex UTS, the logical and connecting relationship of the datasets and how they can be put together to make sense of the full-picture situation is unclear.

    Our research project aims to develop a comprehensive data ontology for climate resilience in UTS. It capitalizes on the collective strengths of two research teams from esteemed institutions—Cambridge and Tsinghua.`, // <--- Closing backtick
